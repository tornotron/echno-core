 ...
 *
 * Barrel export for the attendance domain types — core attendance, clock
 * events, movements, regularizations, attendance profiles/settings, summaries,
 * reports, and the role abstraction — plus their parsers and serializers.
 */
